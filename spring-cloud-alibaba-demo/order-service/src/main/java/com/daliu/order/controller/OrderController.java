...
public class OrderController {
    ...
    public String deductStock(@RequestParam("productId") Long productId, @RequestParam("stockCount") Long stockCount) {
        return this.restTemplate.getForObject("http://stock-service/stock/deduct/" + productId + "/" + stockCount,
                String.class);
    }
    ...
    public String getIpAndPort() {
        return this.restTemplate.getForObject("http://stock-service/stock/getIpAndPort", String.class);
    }
    ...
    *//**
     * 处理BlockException的方法（处理限流，熔断降级）
     *//*
    public String blockHandlerMethod(String a, BlockException e) {
        // 如果被保护的资源被限流或者熔断降级了，就会抛出BlockException
        return "资源被限流或降级了";
    }*/

    /**
     * 处理非sentinel规则限制抛出的Throwable的方法，比如业务异常
     * @param a
     * @return
     */
    @PostMapping
